...
public class SignupOne extends JFrame implements ActionListener {
    long random;
    JTextField nameTextField,fnameTextField,emailaddressTextField,addressTextField,cityTextField,stateTextField,pinTextField;
    JButton next;
    ...
    SignupOne(){
       ...
       emailaddressTextField.setFont(new Font("Raleway",Font.BOLD, 22));
